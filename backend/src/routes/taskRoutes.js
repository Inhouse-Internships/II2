...
router.post('/admin/bulk-import', authenticate, authorizeRoles(ROLES.ADMIN), upload.single('file'), taskController.bulkImportTasks);
...
router.put('/admin/:id', authenticate, authorizeRoles(ROLES.ADMIN), taskController.editTask);
router.delete('/admin/:id', authenticate, authorizeRoles(ROLES.ADMIN), taskController.deleteTask);
router.post('/admin/bulk-delete', authenticate, authorizeRoles(ROLES.ADMIN), taskController.bulkDeleteTasks);
...
router.post('/student/submit/:taskId', authenticate, authorizeRoles(ROLES.STUDENT), taskController.submitTask);
